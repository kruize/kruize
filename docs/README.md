...
Note: In some OpenShift setups adding a custom dashboard is not possible, and in those cases visualization through the Kruize dashboard is not currently supported.
