...
import com.kruize.query.prometheus.docker.runtimes.java.openj9.heap.DockerBalancedHeapQuery;
import com.kruize.query.prometheus.docker.runtimes.java.openj9.heap.DockerGenconHeapQuery;
...
public class DockerOpenJ9JavaQuery extends JavaQuery
{
    ...
    public DockerOpenJ9JavaQuery(String gcPolicy)
    {
        vm = "OpenJ9";
        ...
        switch (gcPolicy) {
            case "gencon":
                heapQuery = new DockerGenconHeapQuery();
                break;
            case "balanced":
                heapQuery = new DockerBalancedHeapQuery();
        }
    }
